...
public class CreateCustomerUseCaseTest {
    ...
    public void testCreate() {
        ...
        Mockito.when(customerService.findByCpf(expectedCPF)).thenReturn(java.util.Optional.empty());
        Mockito.when(customerService.findByEmail(expectedEmail)).thenReturn(java.util.Optional.empty());
