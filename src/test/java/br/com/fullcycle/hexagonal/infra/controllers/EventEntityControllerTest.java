...
import br.com.fullcycle.hexagonal.infra.dtos.NewEventDTO;
import br.com.fullcycle.hexagonal.infra.dtos.SubscribeDTO;
...
@SpringBootTest
class EventEntityControllerTest {
    ...
    void setUp() {
        ...
        disney = partnerRepository.create(Partner.newPartner("Disney", "12.345.678/0001-00", "disney@gmail.com"));
    }
    ...
    public void testReserveTicket() throws Exception {
        ...
        var sub = new SubscribeDTO(null, johnDoe.customerId().value());
